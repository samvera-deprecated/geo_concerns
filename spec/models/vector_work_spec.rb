...
describe VectorWork do
  ...
  context 'with files' do
    subject { FactoryGirl.create(:vector_work_with_files, title: ['Test title 4'], georss_box: '17.881242 -179.14734 71.390482 179.778465') }
  ...
  describe "to_solr" do
    subject { FactoryGirl.build(:vector_work, date_uploaded: Date.today, georss_box: '17.881242 -179.14734 71.390482 179.778465').to_solr }
